...
text = st.text_area("Texte d’entrée", height=220, value="Je sui aller au supermarchet pour achète " \
"du pin et du lais, mes la caissiere a fermer la caise a 18h et jai dus rentré sans rien \n Je sui aller au supermarchet avec Marie Dubois pour achete du pin et du lais")
