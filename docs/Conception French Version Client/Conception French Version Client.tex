...
\textbf{DYS-FR} est une application \textbf{100\,\% hors-ligne} qui clarifie et corrige des textes en français \textbf{sans ajouter d’informations}. Elle s’installe sur Windows en un clic et fonctionne sur des ordinateurs portables standards. L’utilisateur colle son texte, clique sur \textbf{«\,Corriger\,»}, puis visualise les \textbf{modifications} et le \textbf{texte final}.
