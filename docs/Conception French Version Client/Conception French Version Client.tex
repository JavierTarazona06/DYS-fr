...
\textbf{DYS-FR} est une application \textbf{100\,\% hors-ligne} qui clarifie et corrige des textes en français \textbf{sans ajouter d’informations}. Elle empêche la triche : une phrase volontairement incomplète (« l’année de l’indépendance des États-Unis est le .. de .. ») reste non complétée. Elle s’installe sur Windows en un clic et fonctionne sur des ordinateurs portables standards. L’utilisateur colle son texte, clique sur \textbf{«\,Corriger\,»}, puis visualise les \textbf{modifications} et le \textbf{texte final}.
...
\begin{itemize}
  ...
  \item \textbf{Fiabilité} : corrections prudentes, 
    \textbf{zéro invention} (noms, dates, chiffres préservés) et \textbf{anti-triche} (les zones «\,..\,» restent vides).
...
\begin{enumerate}
  ...
  \end{itemize}
  \item Cliquer \textbf{«\,Corriger\,»}.
  \item Consulter :
  \begin{itemize}
    \item \textbf{Diff} (ajouts soulignés, suppressions barrées),
...
\begin{itemize}
  \item Zone de texte large, bouton \textbf{«\,Corriger\,»}.
  \item \textbf{Diff visuel} (ajouts soulignés, suppressions barrées).
...
\begin{itemize}
  ...
  \item Diff avec \texttt{difflib} / \texttt{diff-match-patch} configuré pour souligner les ajouts et barrer les suppressions.
\end{itemize}
...
\begin{itemize}
  ...
  \item Texte de 1--2 phrases corrigé en \textbf{$<$ 1 s} en mode \textbf{Léger}.
  \item \textbf{Aucune invention / anti-triche} : chiffres/dates/noms identiques à l’original et phrases 
    incomplètes («\,..\,» ou «\,…\,») non complétées.
